...
import * as controller from '@/lib/controllers/portfolioController';
import authenticate from '@/lib/middleware/authMiddleware';

const routeMap = {
  "GET": {
    "binance": controller.getBinanceBalances,
    "coindcx": controller.getCoinDCXBalances,
    "all": controller.getAllBalances
  }
};
